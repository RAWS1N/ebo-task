...
function ServiceII({ text, tag }) {
  return (
    <div className="lg:border-l  font-medium px-2 lg:px-4 lg:first:border-0 lg:first:px-0 first:px-4 first:pr-2 border-b p-4  space-y-2 lg:border-b-0 w-11/12 ml-2 first:ml-0">
